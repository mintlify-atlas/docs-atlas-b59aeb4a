---
title: "Runtime Configuration — Dummy Gemini Bot Settings"
sidebarTitle: "Settings"
description: "Edit Dummy Gemini Bot runtime settings from the admin dashboard — model IDs, TTS engines, persona prompts, daily summaries, and yt-dlp tools."
---
